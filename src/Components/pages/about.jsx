...
<p className="text-xl text-[#373535] mb-10">Africa Insurance Company (AIC) is a privately owned Professional 
    Insurance Company established in 1994 in accordance with the
     Licensing and Supervision of Insurance Business Proclamation 
     No.8/1994, and the commercial code of Ethiopia.<br></br>

The company is set up with fully paid up capital of 30 million Ethiopian Birr. 
The capital is divided into 30,000 ordinary shares, each with a par value of 1000 
Ethiopian Birr. The capital base AIC utilizes makes it the Strongest Private Insurance Company in the Country.
<br></br>
Although AIC is a Young Company, its personnel who are implementing the day-to-day activities 
of the company are highly qualified in their particular job assignments which has enabled it to 
provide effective service to its clients. 
<br></br>
The Corporate Motto  <b> Committed to Excellence and Quality Services </b>
...
<div className="flex justify-between p-4">
      ...
      <h1 className="text-3xl mt-8 mb-4 text-[#343989] font-bold text-center mt-12 mb-8">Board Of Directors</h1>
...
{/* MANAGERS */}
    <h1 className="text-3xl mt-8 mb-4 text-[#343989] font-bold text-center mt-12 mb-8">Execetive Management</h1>
       <div className="container mx-auto py-3">
      <div className="grid grid-cols-1">
      <img
              src={Life}
