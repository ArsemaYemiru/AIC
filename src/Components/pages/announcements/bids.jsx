...
const Bids = () => {
  ...
  useEffect(() => {
    fetch('http://localhost/mywordpress/wp-json/wp/v2/posts?categories=4&_embed')
      .then((response) => {
        if (!response.ok) {
      ...
      <div className="flex-grow ml-12 mr-12">
        ...
        <div className="container mx-auto px-4 py-8">
          {posts.map((post) => {
            ...
            const { title, description, deadline, requirements, apply, contact} = acf;
            ...
            return (
              ...
              >
                ...
                <p className="mb-2"><strong>Submission Details:</strong> {apply}</p>
